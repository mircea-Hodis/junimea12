        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BanStart = table.Column<DateTime>(nullable: false),
                    BanEnd = table.Column<DateTime>(nullable: false),
                    FacebookId = table.Column<long>(nullable: true),
                    BannedEmail = table.Column<string>(nullable: true),
                    IsBanActive = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserHighRoles", x => x.RoleId);
                });
